            ...
            <div class="card-body">
                <form method="POST" action="/media/audio/{{$audio->id}}">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="description" id="description" class="form-control @error('description') is-invalid @enderror" value="{{old('description') ? old('description') : $audio->description}}">
